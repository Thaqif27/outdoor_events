                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror" id="category"
                                ...
                                <option value="running" {{ old('category', $event->category) == 'running' ? 'selected' : '' }}>🏃 Running</option>
                                <option value="hiking" {{ old('category', $event->category) == 'hiking' ? 'selected' : '' }}>🥾 Hiking</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="time" class="form-control @error('event_time') is-invalid @enderror"
                                id="event_time" name="event_time" value="{{ old('event_time', $event->event_time) }}"
                                required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="latitude_display" disabled 
                                value="{{ $event->latitude ?? 'Click on map' }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="longitude_display" disabled 
                                value="{{ $event->longitude ?? 'Click on map' }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="url" class="form-control @error('source_url') is-invalid @enderror"
                                id="source_url" name="source_url" value="{{ old('source_url', $event->source_url) }}"
