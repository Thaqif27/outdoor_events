    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-5 animate-fade-in">
            ...
            <div class="glass px-4 py-2 rounded-pill">
                <i class="fas fa-user-shield text-primary me-2"></i> {{ auth()->user()->name }}
            </div>
        </div>
            ...
            <div class="col-md-3 animate-fade-in delay-1">
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">{{ $totalEvents }}</h2>
            ...
            <div class="col-md-3 animate-fade-in delay-2">
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">{{ $totalUsers }}</h2>
            ...
            <div class="col-md-3 animate-fade-in delay-3">
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">{{ $upcomingEvents }}</h2>
                ...
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">
                            {{ \App\Models\Event::join('event_participants', 'events.id', '=', 'event_participants.event_id')->count() }}
                        </h2>
            ...
            <div class="col-12">
                <div class="glass p-4 rounded-4">
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('admin.events.create') }}" class="btn btn-outline-primary rounded-pill">
