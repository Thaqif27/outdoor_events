    ...
    <div class="container py-5">
            ...
            <div class="col-md-4 animate-fade-in delay-1">
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">{{ $stats['joined'] }}</h2>
            ...
            <div class="col-md-4 animate-fade-in delay-2">
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">{{ $stats['favourites'] }}</h2>
            ...
            <div class="col-md-4 animate-fade-in delay-3">
                <div class="card border-0 shadow-sm h-100 overflow-hidden text-white"
                    ...
                    <div class="card-body p-4 position-relative">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-0">{{ $stats['upcoming'] }}</h2>
        ...
        <div class="glass p-5 rounded-4 text-center animate-fade-in delay-2">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="{{ route('user.events.index') }}" class="btn btn-primary btn-lg rounded-pill px-5 shadow-sm">
                    <i class="fas fa-search me-2"></i> Find Adventures
                </a>
                <a href="{{ route('user.events.create') }}" class="btn btn-success btn-lg rounded-pill px-5 shadow-sm">
                    <i class="fas fa-plus me-2"></i> Create Event
                </a>
                <a href="{{ route('user.events.map') }}" class="btn btn-outline-success btn-lg rounded-pill px-5">
