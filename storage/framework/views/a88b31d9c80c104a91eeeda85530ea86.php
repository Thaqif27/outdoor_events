<?php $__env->startSection('content'); ?>
    ...
    <div class="hero-section text-center"
        style="background-image: url('<?php echo e(asset('images/hero-bg.jpg')); ?>');">
        ...
        <div class="container animate-fade-in py-5">
            ...
            <div class="d-flex justify-content-center gap-3">
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg px-5 py-3 fw-bold rounded-pill">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="event-card text-center p-4">
                        ...
                        <p class="card-text text-muted mb-4">From fun runs to full marathons. Challenge your endurance and
                            speed.</p>
                        <a href="<?php echo e(route('user.events.index', ['category' => 'running'])); ?>"
                ...
                <div class="col-md-4">
                    <div class="event-card text-center p-4">
                        ...
                        <a href="<?php echo e(route('user.events.index', ['category' => 'hiking'])); ?>"
                ...
                <div class="col-md-4">
                    <div class="event-card text-center p-4">
                        ...
                        <a href="<?php echo e(route('user.events.index', ['category' => 'cycling'])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\outdoor-events\resources\views/welcome.blade.php ENDPATH**/ ?>