...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Outdoor Events'); ?></title>
                    ...
                    <ul class="navbar-nav ms-auto gap-1">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->isAdmin()): ?>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.dashboard')); ?>">Dashboard</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.events.index')); ?>">Events</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.users.index')); ?>">Users</a></li>
                                <li class="nav-item"><a class="nav-link"
                                        href="<?php echo e(route('admin.timetable.index')); ?>">Timetable</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.scraper.index')); ?>">Scraper</a>
                                </li>
                            <?php else: ?>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('user.dashboard')); ?>">Dashboard</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('user.events.index')); ?>">Explore
                                        Events</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('user.events.map')); ?>">Map</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('user.timetable.index')); ?>">My
                                        Schedule</a></li>
                            <?php endif; ?>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3 overflow-hidden">
                                    <?php if(auth()->user()->isAdmin()): ?>
                                        <li><a class="dropdown-item py-2" href="<?php echo e(route('admin.profile.show')); ?>"><i
                                                    class="fas fa-user text-primary me-2"></i> Profile</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                    <?php else: ?>
                                        <li><a class="dropdown-item py-2" href="<?php echo e(route('user.favourites.index')); ?>"><i
                                                    class="fas fa-heart text-danger me-2"></i> Favourites</a></li>
                                        <li><a class="dropdown-item py-2" href="<?php echo e(route('user.profile.show')); ?>"><i
                                                    class="fas fa-user text-primary me-2"></i> Profile</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item"><a class="nav-link btn btn-sm bg-white text-dark ms-2 px-3 fw-bold"
                                    href="<?php echo e(route('register')); ?>" style="color: var(--primary-color) !important;">Get
                                    Started</a></li>
                        <?php endif; ?>
                    </ul>
                </ul>
    ...
    <footer class="premium-footer">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-2">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-decoration-none">Home</a></li>
                        <li><a href="<?php echo e(route('user.events.index')); ?>" class="text-decoration-none">Events</a></li>
            ...
            <div class="border-top mt-5 pt-4 text-center small">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Outdoor Events. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\laragon\www\outdoor-events\resources\views/layouts/app.blade.php ENDPATH**/ ?>