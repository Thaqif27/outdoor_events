...
<?php $__env->startSection('title', 'System Automation Status'); ?>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row text-center mt-4">
                                    <div class="col-6 border-end">
                                        <h2 class="display-4 fw-bold text-primary mb-0"><?php echo e(\App\Models\Event::count()); ?>
                                    ...
                                    <div class="col-6">
                                        <h2 class="display-4 fw-bold text-success mb-0">
                                            <?php echo e(\App\Models\Event::where('status', 'upcoming')->count()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\outdoor-events\resources\views/admin/scraper/index.blade.php ENDPATH**/ ?>